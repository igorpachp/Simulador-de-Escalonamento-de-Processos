...
#define MAX_ARRIVAL     8  // maior instante de tempo permitido para entrada de um novo processo
#define MAX_BURST_TIME  10  // limite de tempo de execução necessário para um processo
